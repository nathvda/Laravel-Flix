...
<x-navigation-bar><span class="text-white font-bolder">Welcome back, <span class="font-black">{{$profile->username}}</span>, what will you be watching today ?</span>
    ...
    <h3 class="text-white text-xl flex items-center font-black mt-10 h-8 leading-8">{{$genre->name}}<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#FFFFFF" class="bi bi-chevron-right" viewBox="0 0 16 16">
